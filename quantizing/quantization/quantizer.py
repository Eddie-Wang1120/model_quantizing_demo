...
class Quantizer(object):
    ...
    def prepare_model(self, dummy_input=None):
        ...
        model_device = quantizing.model_device(self.model)
        ...
        quantizing.assign_layer_fq_names(self.model)
        ...
        for name, module in container.named_children():
            ...
            if current_qbits.acts is None and current_qbits.wts is None and not self.module_overrides_map[full_name]:
                ...
                if replace_fn is not None:
                    valid_kwargs, invalid_kwargs = quantizing.filter_kwargs(self.module_overrides_map[full_name],
                                                                           replace_fn)
                    if invalid_kwargs:
                    ...
                    if new_module != module:
                        ...
                        if not quantizing.has_children(module) and quantizing.has_children(new_module):
